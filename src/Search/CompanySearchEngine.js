...
const CompanySearchEngine = () => {
  ...
  const searchZauba = () => {
    ...
    const query = encodeURIComponent(`${companyName}+site: zaubacorp`);
    window.open(`https://www.google.com/search?q=${query}`, '_blank');
  };

  const searchCompanyCheck = () => {
    const companyName = document.getElementById('companyName').value;
    const query = encodeURIComponent(`${companyName}+site: thecompanycheck`); // Replace 'thecompanycheck.com' with the actual domain
    window.open(`https://www.google.com/search?q=${query}`, '_blank');
  };

  const searchCompanyCheck = () => {
    const companyName = document.getElementById('companyName').value;
    const query = encodeURIComponent(`${companyName}+site: Tofler`); // Replace 'thecompanycheck.com' with the actual domain
    window.open(`https://www.google.com/search?q=${query}`, '_blank');
  };
